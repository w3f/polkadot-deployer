...
class Helm {
  ...
  async _installPrometheusOperator() {
    await this._cmd(`upgrade --install prometheus-operator --set opsgenie.enabled=${this.config.opsgenie} --set opsgenie.token=${this.opsgenieToken} --set opsgenie.url=${this.opsgenieUrl} --version ${this.mainConfig.chartVersions['prometheus-operator']} stable/prometheus-operator`);                                                                                                                                                                  
  }
