...
class Helm {
  ...
  async _installPrometheusOperator() {
    const origin = './config/charts/templates/prometheus-operator-opsgenie.tpl'
    const target = './config/charts/prometheus-operator.yaml'
    const data = {
    ...
    // todo: copy the prometheus-operator.yaml file inside container
