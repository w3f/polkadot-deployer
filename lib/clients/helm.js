...
class Helm {
  ...
  async _installCertManager() {
    // only install cert-manager CRDs if they don't exist, see https://cert-manager.io/docs/installation/upgrading/upgrading-0.15-0.16/#issue-with-older-versions-of-kubectl
