...
class Helm {
  ...
  async _installCertManager() {
    ...
    await this._cmd(`upgrade --install cert-manager --timeout 600 --namespace cert-manager --version ${this.mainConfig.chartVersions['cert-manager']} jetstack/cert-manager`);
