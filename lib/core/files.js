...
class Files {
  ...
  deleteDeploymentDirectories(name) {
    ...
    if (this.config.remote.clusters) {
  ...
  copyTerraformFiles(name, type) {
    ...
    let stats = fs.statSync(terraformBinSource);
    let fileSizeInBytes = stats.size;
    console.log(`${terraformBinSource} size before copy: ${fileSizeInBytes}`)

    stats = fs.statSync(terraformBinSource);
    fileSizeInBytes = stats.size;
    console.log(`${terraformBinSource} size after copy: ${fileSizeInBytes}`)
  }
